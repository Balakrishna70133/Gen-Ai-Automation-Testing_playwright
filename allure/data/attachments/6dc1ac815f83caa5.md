...
- Name: POMWithBaseAndData.spec.ts >> POM with Base and Data >> Create and Delete Employee using Xpath and CSS
- Location: tests/POMWithBaseAndData.spec.ts:12:9
